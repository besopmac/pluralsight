...
var beginningScenarios = [
    "You wake up in a hospital. It is eerily quiet. You tiptoe to the door is peek out.",
    "You are standing in an open field west of a white house with a boarded front door. There is small mailbox here.",
...
if (survival === 0) {
    ...
    alert("You defeat the zombie with you " + weapon + "! You win!");
}
